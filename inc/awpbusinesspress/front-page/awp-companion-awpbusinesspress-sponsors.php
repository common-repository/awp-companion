<?php
if ( 'Hospital Health Care' == $activate_theme || 'Home Interior' == $activate_theme || 'Business Campaign' == $activate_theme || 'Awp Marketing Agency' == $activate_theme ) {
...
if ( 'Home Interior' == $activate_theme || 'Awp Marketing Agency' == $activate_theme ) {
				...
				<div class="row theme-sponsors-content wow animate fadeInUp" data-wow-delay=".3s">
					<div class="col-md-12">
						...
						if ( $awpbusinesspress_client_content != '' ) {
							...
							if ( 'Home Interior' == $activate_theme || 'Business Campaign' == $activate_theme || 'Awp Marketing Agency' == $activate_theme ) {
